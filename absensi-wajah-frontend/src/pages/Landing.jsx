...
const Landing = () => {
    ...
    const steps = [
        { num: '01', title: 'Daftarkan Wajah', desc: 'Cukup sekali registrasi via kamera. Data wajah Anda tersimpan aman sebagai referensi absensi.', icon: <FiCamera size={22} /> },
        { num: '02', title: 'Absen Tiap Hari', desc: 'Clock-in & clock-out cukup dengan menghadap kamera. Sistem mencocokkan wajah secara otomatis.', icon: <FiClock size={22} /> },
        { num: '03', title: 'Pantau & Evaluasi', desc: 'Lihat riwayat, ajukan izin, dan dapatkan notifikasi status kehadiran secara real-time.', icon: <FiBarChart2 size={22} /> }
    ];
    ...
    return (
        <div className="min-h-screen" style={{ background: 'var(--bg-page)' }}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:flex items-center gap-1">
                            <a href="#features" className="px-4 py-2 text-sm font-medium rounded-xl hover-bg" style={{ color: 'var(--text-secondary)' }}>Fitur</a>
                            <a href="#how-it-works" className="px-4 py-2 text-sm font-medium rounded-xl hover-bg" style={{ color: 'var(--text-secondary)' }}>Cara Kerja</a>
                            <Link to="/tentang" className="px-4 py-2 text-sm font-medium rounded-xl hover-bg" style={{ color: 'var(--text-secondary)' }}>Tentang</Link>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Link to="/login"
                                className="hidden sm:inline-flex px-4 py-2 text-sm font-medium rounded-xl hover-text"
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            ...
                            <a href="#features" className="btn-secondary text-base px-8 py-3.5">Pelajari Fitur</a>
                        </div>
            ...
            <section id="features" className="py-24 md:py-32">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        {features.map((f, i) => (
                            <div key={i}
                                className="group rounded-2xl p-6 cursor-default hover-card"
            ...
            <section id="how-it-works" className="py-24 md:py-32" style={{ background: 'var(--gradient-hero)' }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4" style={{ color: 'var(--text-heading)' }}>Cara Kerja</h2>
                        <p className="text-lg" style={{ color: 'var(--text-secondary)' }}>Tiga langkah sederhana untuk transformasi absensi perusahaan Anda.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative">
                        ...
                        {steps.map((step, i) => (
                            <div key={i} className="relative text-center group">
                                ...
                                <div className="text-5xl font-black mb-1 select-none" style={{ color: 'var(--text-muted)', opacity: 0.15 }}>{step.num}</div>
            ...
            <section className="py-24 md:py-32">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="rounded-3xl p-10 md:p-16 relative overflow-hidden"
                        ...
                        <div className="absolute top-0 right-0 w-40 h-40 opacity-[0.06] rounded-bl-full pointer-events-none" style={{ background: 'var(--gradient-primary)' }} />
                        <div className="absolute bottom-0 left-0 w-32 h-32 opacity-[0.04] rounded-tr-full pointer-events-none" style={{ background: 'linear-gradient(135deg, #7091a8, #c19066)' }} />
                        <div className="relative">
                            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4" style={{ color: 'var(--text-heading)' }}>Siap Mencoba?</h2>
                            <p className="text-lg max-w-lg mx-auto mb-8" style={{ color: 'var(--text-secondary)' }}>
                                Bergabunglah dengan perusahaan lain yang telah mempercayakan absensi pada sistem kami. Gratis untuk dicoba.
                            </p>
                            <Link to="/login" className="btn-primary text-base px-8 py-3.5 shadow-lg">
